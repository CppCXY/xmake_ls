...
mod tests {
    ...
    #[gtest]
    fn test_emmylua_issue_272() -> Result<()> {
        let mut ws = ProviderVirtualWorkspace::new();
        check!(ws.check_completion_with_kind(
            r#"
                ---@class Box
    ...
    #[gtest]
    fn test_emmylua_issue_502() -> Result<()> {
        let mut ws = ProviderVirtualWorkspace::new();
        ws.def(
            r#"
    ...
    #[gtest]
    fn test_emmylua_issue_558() -> Result<()> {
        let mut ws = ProviderVirtualWorkspace::new();
        ws.def_file(
            "AAA.lua",
            r#"
    ...
    #[gtest]
    fn test_emmylua_issue_572() -> Result<()> {
        let mut ws = ProviderVirtualWorkspace::new();
        check!(ws.check_completion(
            r#"
                ---@class A
    ...
    #[gtest]
    fn test_emmylua_issue_646() -> Result<()> {
        let mut ws = ProviderVirtualWorkspace::new();
        ws.def(
            r#"
            ---@class Base
